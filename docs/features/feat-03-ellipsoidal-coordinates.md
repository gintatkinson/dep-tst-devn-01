...
## Parent Epic
- [ ] #TBD - Geographic Location: YANG Geo-Location Grouping (docs/epics/epic-01-geo-location.md) (parent module container that owns the location choice — ellipsoid case)
